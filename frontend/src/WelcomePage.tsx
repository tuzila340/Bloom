        ...
        <div className="card-block">
          <div className="card">
            ...
            <p className="card-description">
              friendly nudges instead of red alerts when you're close to a limit
            </p>
          </div>
          <div className="card">
            <i></i>
      ...
      <section id="features">
        <div className="wrap">
          <div className="section-head">
            ...
            <p>
              Bloom keeps budgeting to the essentials: know what you have, know
              what you're working toward, and get a nudge before things go
              sideways.
            </p>
          </div>
          ...
          <div className="feature-grid">
            ...
            <div className="feature-card">
              ...
              <h3>savings goals</h3>
              <p>
                Set a target and watch your progress fill in as you get closer.
              </p>
            </div>
          </div>
          ...
          <div className="spotlight">
            <div className="spotlight-text">
              ...
              <p>
                Ask plain questions like "can I afford a trip in March?" and get
                an answer grounded in your real numbers, not a generic rule of
                thumb.
              </p>
            </div>
            <div className="spotlight-visual">
      ...
      <section id="about">
        <div className="wrap">
          ...
          <div className="about-hero">
            <h2>
              most budgeting apps are built to make you feel bad about money. we
              built bloom to help you feel better about it.
            </h2>
          </div>
          ...
          <div className="about-body">
            <p>
              ...
              tried felt like a spreadsheet wearing a coat of paint, or worse, a
              tool that scolded us for buying coffee. Neither approach made
